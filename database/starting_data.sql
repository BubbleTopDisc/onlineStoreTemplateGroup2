...
INSERT into `inventory` (`item_name`, `info`, `price`, `price_range`, `stock`, `image_url`, `category`)
VALUES ('Desktops', 'Great as a workstation or as your high power pc.', 150, "150.00 - $3,500.00 average prices", 100, 'static/images/apple.jpeg', 'Fruit');

INSERT into `inventory` (`item_name`, `info`, `price`, `price_range`, `stock`, `image_url`, `category`)
VALUES ('Monitors', 'Big or Small, Short or Wide, Find the best monitor for you!',90, "90.00 - $500.00 average prices", 100, 'static/images/banana.jpeg', 'Fruit');

INSERT into `inventory` (`item_name`, `info`, `price`, `price_range`, `stock`, `image_url`, `category`)
VALUES ('Laptops', 'Find the portable computer that works best for you', 200, "200.00 - $2,000 average prices", 100, 'static/images/mango.jpeg', 'Fruit');
