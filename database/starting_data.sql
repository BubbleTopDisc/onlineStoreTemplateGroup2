...
VALUES ('Desktop Computer', 'Great as a workstation or as your high power pc.', 2.00, 100, 'static/images/apple.jpeg', 'Fruit');

INSERT into `inventory` (`item_name`, `info`, `price`, `stock`, `image_url`, `category`)
VALUES ('Monitors', 'Big or Small, Short or Wide, Find the best monitor for you!', 1.00, 100, 'static/images/banana.jpeg', 'Fruit');

INSERT into `inventory` (`item_name`, `info`, `price`, `stock`, `image_url`, `category`)
VALUES ('Laptops', 'Find the portable computer that works best for you', 4.00, 100, 'static/images/mango.jpeg', 'Fruit');
